...
//////////////////////////////////버튼 설정
            ...
            btn_current_location.setOnClickListener {
                ...
                rotateAnimation.duration = 300 // Set the duration of the animation (0.5 seconds)
                ...
                if (ContextCompat.checkSelfPermission(
                    ...
                    startSpeechToText(object : SpeechRecognitionCallback {
                        override fun onSpeechRecognitionCompleted(inputText: String) {
                            if (kor == 1) {
                                // Execute code after 1-second delay
                                Handler().postDelayed({
                                    speak1()
                                }, 500)

                                // Perform other tasks here or continue with the code

                                // Execute the AI function after a 3-second delay
                                Handler().postDelayed({
                                    ai()
                                }, 3000)
                                ...
                                // Execute the AI function after a 4-second delay
                                Handler().postDelayed({
                                    ai()
                                }, 4000)

                                // Execute code after another 1-second delay (5 seconds from the beginning)
                                Handler().postDelayed({
                                    speak2()
                                }, 1000)
                            }
